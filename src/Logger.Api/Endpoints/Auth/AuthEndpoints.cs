...
using Logger.Api.Endpoints.Auth.Handlers.LoginUser;
using Logger.Api.Endpoints.Auth.Handlers.LogoutUser;
using Logger.Api.Endpoints.Auth.Handlers.RefreshSession;
using Logger.Api.Endpoints.Auth.Handlers.RegisterUser;
using Logger.Api.Models;
using Logger.Application.Features.Auth.Models;
using Scalar.AspNetCore;

namespace Logger.Api.Endpoints.Auth;
